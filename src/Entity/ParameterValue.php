 ...
 *        "normalization_context"={"groups"={"parameterValue_read"}},
 *        "denormalization_context"={"groups"={"parameterValue_write"}}
 *     } ) 
 ...
 */
class ParameterValue extends AbstractTranslatable
{
    /**
     * @ORM\Id()
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\ParameterValueTranslation", mappedBy="ParameterValue", cascade={"persist", "remove"})
     */
     ...
     * @Groups({"parameterValue_read", "parameterValue_write", "translations"})s
     */
    ...
    {
        return new ParameterValueTranslation();
    }

    /**
     * @return Collection|ParameterValueTranslation[]
     */
